    ...
    return (
        <section>
            <nav>
                <div id="nav-menu">
                    <ul id="nav-buttons">
                        <li className="button border-right current-page" id="home-button">
            ...
            <main>
                ...
                <div id="content" className="home-padding">
                    <div id="los-angeles">
                        <img className="ornament" src={ornament_left} alt="ornament" />
                        Los Angeles
                        <img className="ornament" src={ornament_right} alt="ornament" />
                    </div>
                    <div className="frame" style={{marginBottom: '2%'}}>
                    ...
                    <br />
                    <div className="heading"><h2>Greater Los Angeles</h2><div className="heading-line"></div></div>
                    <br />
                    ...
                    <br />
                    <a href="https://commons.wikimedia.org/wiki/File:GreaterLAmap.png" target="_blank" rel="noreferrer"><img id="map" className="frame" src={gtla_map} alt="map" /></a>
                    ...
                    <br />
                    <iframe id="google-map" className="frame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d510916.3193083496!2d-118.69191580241026!3d34.0207304978277!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2c75ddc27da13%3A0xe22fdf6f254608f4!2sLos%20Angeles%2C%20CA%2C%20USA!5e1!3m2!1sen!2sbg!4v1630053439495!5m2!1sen!2sbg" title="Google map" allowFullScreen="" loading="lazy"></iframe>
                    <br />
                    ...
                    <br />
                    <p className="info-source">Source: <a href="https://en.wikipedia.org/wiki/Greater_Los_Angeles" target="_blank" rel="noreferrer">Wikipedia</a></p>
                </div>
