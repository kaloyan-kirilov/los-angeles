        ...
        <section>
            <nav>
                <div id="nav-menu">
                    <ul id="nav-buttons">
                        ...
                        <li class="button border-right current-page">
                            <div class="button-content">
            ...
            <main>
                ...
                <div id="content" class="padding">
                    <div class="heading"><h2>California</h2><div class="heading-line"></div></div>
                    <br />
                    <div id="state">
                        ...
                        <a href="https://commons.wikimedia.org/wiki/File:California_in_United_States.svg" target="_blank" rel="noreferrer"><img class="frame" src={state_map} style={{width: '100%'}} alt="state map" /></a>
                    </div>
                    ...
                    <br />
                    <img class="frame" src={state_image} style={{width: '100%'}} alt="state" />
                    <br />
                    ...
                    <br />
                    <img id="hollywood" class="frame" src={hollywood} alt="hollywood" />
                    ...
                    <br />
                    <p class="info-source">Source: <a href="https://en.wikipedia.org/wiki/California" target="_blank" rel="noreferrer">Wikipedia</a></p>
                    <br />
                    <p class="info-source">Official website: <a href="https://www.ca.gov/" target="_blank" rel="noreferrer">www.ca.gov</a></p>
                </div>
