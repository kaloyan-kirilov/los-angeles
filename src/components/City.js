        ...
        <section>
            ...
            <main>
                ...
                <div id="content" class="padding">
                    <div class="heading"><h2>City of Angels</h2><div class="heading-line"></div></div>
                    <br />
                    <img class="frame" src={la_city} style={{width: '100%'}} alt="la city" />
                    <br />
                    ...
                    <br />
                    <img id="la-griffith" class="frame" src={la_griffith} alt="la griffith" />
                    ...
                    <br />
                    <p class="info-source">Source: <a href="https://en.wikipedia.org/wiki/Los_Angeles" target="_blank" rel="noreferrer">Wikipedia</a></p>
                    <br />
                    <p class="info-source">Official website: <a href="https://www.lacity.org/" target="_blank" rel="noreferrer">www.lacity.org</a></p>
                </div>
