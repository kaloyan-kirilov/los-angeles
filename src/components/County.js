        ...
        <section>
            ...
            <main>
                ...
                <div id="content" class="padding">
                    <div class="heading"><h2>County of Los Angeles</h2><div class="heading-line"></div></div>
                    <br />
                    <div id="county">
                        ...
                        <a href="https://commons.wikimedia.org/wiki/File:Map_of_California_highlighting_Los_Angeles_County.svg" target="_blank" rel="noreferrer"><img class="frame" src={county_map} style={{width: '100%'}} alt="county map" /></a>
                    </div>
                    ...
                    <br />
                    <p class="info-source">Source: <a href="https://en.wikipedia.org/wiki/Los_Angeles_County,_California" target="_blank" rel="noreferrer">Wikipedia</a></p>
                    <br />
                    <p class="info-source">Official website: <a href="https://lacounty.gov/" target="_blank" rel="noreferrer">www.lacounty.gov</a></p>
                </div>
